...
// Lấy danh sách đơn đặt sân (có LIMIT/OFFSET)
$query = "
    SELECT
        b.*,
        r.court_code,
    ...
    FROM bookings b
    LEFT JOIN courts r ON b.court_id = r.id
...
<body>
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div class="row mb-4">
                            <div class="col-12">
                                <h4 class="mb-1">📋 Lịch sử đặt sân của tôi</h4>
                                <p class="text-muted mb-0">Quản lý và theo dõi các đơn đặt sân của bạn</p>
                            </div>
                        </div>
                        ...
                        <div class="bookings-list" id="bookingsList">
                            <?php if (empty($bookings)): ?>
                                <div class="empty-state">
                                    ...
                                    <div class="empty-state-text">Không có đơn đặt sân nào</div>
                                    <p class="text-muted">Hãy <a href="../../admin/booking/booking-room.php">đặt sân</a> để bắt đầu</p>
                                </div>
                            <?php else: ?>
                                <?php foreach ($bookings as $booking): ?>
                                    ...
                                    <div class="booking-card <?php echo $statusInfo['class']; ?>" data-status="<?php echo $booking['status']; ?>">
                                        ...
                                        <div class="booking-grid">
                                            <div class="info-item"><div class="info-label">🏠 Phòng</div><div class="info-value"><?php echo htmlspecialchars($booking['court_code']); ?> - <?php echo htmlspecialchars($booking['court_name']); ?></div></div>
    ...
    <div class="modal-overlay" id="detailModal">
        <div class="modal-content">
            <div class="modal-header"><div class="modal-title">Chi tiết đơn đặt sân</div><button class="modal-close" onclick="closeModal()">×</button></div>
            <div class="modal-body">
                ...
                <div class="detail-section">
                    ...
                    <div class="detail-grid">
                        <div class="detail-item">
                            <div class="detail-label">mã sân</div>
                            <div class="detail-value" id="detailRoomCode">--</div>
                        </div>
                        <div class="detail-item">
                            <div class="detail-label">tên sân</div>
                ...
                <div class="detail-section">
                    ...
                    <div class="detail-grid">
                        <div class="detail-item">
                            <div class="detail-label">Ngày đặt sân</div>
    ...
    <script>
        ...
        function viewDetail(code) {
            ...
            document.getElementById('detailRoomType').textContent = booking.category_name;
