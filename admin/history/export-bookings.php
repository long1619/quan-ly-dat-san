...
$query_all = "
    SELECT b.*, r.court_code, r.court_name
    FROM bookings b
        ...
        <tbody>
            <?php foreach ($bookings as $index => $booking): ?>
                <tr>
                    ...
                    <td><?php echo $booking['court_code'] . ' - ' . $booking['court_name']; ?></td>
...
function exportToPDF($bookings) {
    ...
    <html>
    <head>
        <title>Xuất PDF - Lịch sử đặt sân</title>
        <meta charset="utf-8">
                    ...
                    buttons: [
                        {
                            ...
                            customize: function(doc) {
                                ...
                                doc['footer'] = function(page, pages) {
                                    return {
                                        columns: [
                                            { text: 'Hệ thống Quản lý sân thể thao', alignment: 'left', margin: [40, 0], fontSize: 8 },
