                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div class="row mb-4">
                            <div class="col-12">
                                ...
                                <p class="text-muted mb-0">Tất cả các đơn đặt sân đã bị hủy</p>
                            </div>
                        </div>
                                    ...
                                    <div class="booking-card">
                                        ...
                                        <div class="booking-grid">
                                            <div class="info-item">
                                                ...
                                                <div class="info-value"><?php echo htmlspecialchars($booking['court_code']); ?> - <?php echo htmlspecialchars($booking['court_name']); ?></div>
                                            </div>
                                            <div class="info-item">
                ...
                <div class="detail-section">
                    ...
                    <div class="detail-grid">
                        <div class="detail-item">
                            <div class="detail-label">Mã đơn đặt sân</div>
