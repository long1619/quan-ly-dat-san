...
// Kiểm tra quyền sửa Loại sân
if (!checkPermission($conn, $userRole, 'edit_court_category')) {
    echo "<script>alert('Bạn không có quyền chỉnh sửa Loại sân!'); window.location.href='../dashboard/index.php';</script>";
    exit;
}
...
if (empty($old)) {
    $stmt = $conn->prepare("SELECT * FROM court_categories WHERE id = ?");
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div class="row mb-4">
                            <div class="col-12">
                                <h4 class="mb-1">Chỉnh sửa Loại sân</h4>
                            </div>
                        </div>
                        <?php if (!empty($errors)): ?>
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                <form method="POST" action="process-edit-type-court.php">
                                    <input type="hidden" name="id" value="<?= htmlspecialchars($id) ?>">
                                    <div class="row">
                                        <div class="mb-3 col-md-6">
                                            <label for="category_name" class="form-label">Tên Loại sân</label>
                                            <input class="form-control" type="text" id="category_name" name="category_name"
                                                value="<?= htmlspecialchars($old['category_name'] ?? '') ?>" required />
                                        </div>
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <a href="list-type-court.php" class="btn btn-outline-secondary">Hủy</a>
                                    </div>
                                </form>
                            </div>
                        </div>
