<?php
    ...
    // Lấy thông tin phòng và Loại sân
    $stmt = $conn->prepare("
        SELECT r.*, rt.category_name, rt.description as type_description
        FROM courts r
                        ...
                        <div class="container-xxl grow container-p-y">
                            ...
                            <div class="profile-header">
                                ...
                                <div class="profile-info">
                                    <h3><?php echo htmlspecialchars($room['court_name']); ?></h3>
                                    <div class="meta">
                                        <span><i class="bx bx-barcode"></i> Mã sân:
                                            <?php echo htmlspecialchars($room['court_code']); ?></span>
                            ...
                            <div class="profile-tabs mt-3">
                                <div class="profile-content ">
                                    ...
                                    <ul class="profile-list">
                                        <li><i class="bx bx-barcode"></i> <strong>Mã sân:</strong>&nbsp;
                                            <?php echo htmlspecialchars($room['court_code']); ?></li>
                                        <li><i class="bx bx-door-open"></i> <strong>Tên sân:</strong>&nbsp;
                                            <?php echo htmlspecialchars($room['court_name']); ?></li>
                                        <li><i class="bx bx-category"></i> <strong>Loại sân:</strong>&nbsp;
                                            <?php echo htmlspecialchars($room['category_name'] ?? 'Chưa xác định'); ?></li>
                                        <li><i class="bx bx-area"></i> <strong>Khu vực:</strong>&nbsp;
                                            <?php echo htmlspecialchars($room['area'] ?? 'Chưa có thông tin'); ?></li>
                                        <li><i class="bx bx-layer"></i> <strong>Loại mặt sân:</strong>&nbsp;
                                            <?php echo $room['surface_type'] ? htmlspecialchars($room['surface_type']) : 'Chưa có thông tin'; ?></li>
                                    ...
                                    <div class="mt-4 pb-4">
                                        <?php if ($room['is_active'] == 1): ?>
                                            <?php if ($room['status'] == 'bao_tri'): ?>
                                                <button class="btn btn-primary" onclick="showMaintenanceAlert('<?= htmlspecialchars($room['court_code']) ?>')">
                                                    <i class="bx bx-calendar-plus me-1"></i> Đặt sân này
                                                </button>
                                            <?php else: ?>
                                            ...
                                            <?php endif; ?>
                                        <?php endif; ?>
                                        <a href="list-court.php" class="btn btn-outline-secondary ms-2">
        ...
        <script>
            function showMaintenanceAlert(roomCode) {
                Swal.fire({
                    ...
                    text: 'Phòng ' + roomCode + ' đang trong quá trình bảo trì. Vui lòng chọn sân khác hoặc quay lại sau.',
